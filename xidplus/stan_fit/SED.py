...
def MIPS_PACS_SPIRE(phot_priors,sed_prior_model,chains=4,iter=1000,max_treedepth=10,seed=143):
    ...
    'Row_psw': prior250.amat_row.astype(int),
    'Col_psw': prior250.amat_col.astype(int),
        'npix_pmw': prior350.snpix,
        'nnz_pmw': prior350.amat_data.size,
        'db_pmw': prior350.sim,
        'sigma_pmw': prior350.snim,
        'Val_pmw': prior350.amat_data,
    'Row_pmw': prior350.amat_row.astype(int),
    'Col_pmw': prior350.amat_col.astype(int),
        'npix_plw': prior500.snpix,
        'nnz_plw': prior500.amat_data.size,
        'db_plw': prior500.sim,
        'sigma_plw': prior500.snim,
        'Val_plw': prior500.amat_data,
    'Row_plw': prior500.amat_row.astype(int),
    'Col_plw': prior500.amat_col.astype(int),
    ...
    'Row_mips24': prior24.amat_row.astype(int),
    'Col_mips24': prior24.amat_col.astype(int),
    ...
    'Row_pacs100': prior100.amat_row.astype(int),
    'Col_pacs100': prior100.amat_col.astype(int),
    ...
    'Row_pacs160': prior160.amat_row.astype(int),
    'Col_pacs160': prior160.amat_col.astype(int),
